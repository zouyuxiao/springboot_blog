...
public class ContentsServiceImpl implements ContentsService {
    ...
    @Override
    public List<Contents> list(Contents contents) {
        return contentsDao.list(contents);
    }
    ...
    @Override
    public List<Contents> selectByIdComment(Long id) {
        return contentsDao.selectByIdComment( id );
    }

    @Override
    public List<Comment> selectComment(Long id) {
        return contentsDao.selectComment( id );
    }
}
